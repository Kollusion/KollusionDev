...
export const metadata: Metadata = {
    ...
    authors: [{ name: "Kollusion", url: "https://kollusion.pro" }],
    creator: "Kollusion",
    publisher: "Kollusion",
    ...
    openGraph: {
        ...
        images: [
            {
                url: "https://kollusion.pro/og-image.png",
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: ["https://kollusion.pro/og-image.png"],
    },
    ...
    alternates: {
        canonical: "https://kollusion.pro",
        languages: {
            "en-US": "https://kollusion.pro/en",
            "ru-RU": "https://kollusion.pro/ru",
        },
    },
